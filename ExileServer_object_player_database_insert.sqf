...
private["_player", "_playerID","_moneyStart"];
_player = _this;
...
_moneyStart = 50000;
format["updateLocker:%1:%2", _moneyStart, _player getVariable ["ExileOwnerUID", "SomethingWentWrong"]] call ExileServer_system_database_query_fireAndForget;
_player setVariable ["ExileLocker", _moneyStart, true];
